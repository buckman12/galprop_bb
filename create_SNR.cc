...
int Galprop::create_SNR()
{
	...
	if(galdef.verbose>=2 || galdef.verbose==-401) { // selectable debug AWS20010410
		cout<<"galaxy.SNR_cell_time :"<<endl;
		galaxy.SNR_cell_time .print();
		cout<<"galaxy.SNR_cell_phase:"<<endl;
		galaxy.SNR_cell_phase.print();

		cout<<"galaxy.SNR_electron_dg:"<<endl;
		galaxy.SNR_electron_dg.print(); //AWS20010410
		cout<<"galaxy.SNR_nuc_dg:     "<<endl;
		galaxy.SNR_nuc_dg     .print(); //AWS20010410
	}
