...
// identify primary electrons IMOS20070725
	...
	if(ielectrons==-1) {
		WARNING("CR primary electrons not found!");     //AWS20131106 remove return stat
	} else {
		buf.str("");
...
// identify primary positrons AWS20131106
	...
	if(ielectrons==-1) {
		WARNING("CR primary positrons not found!");
	} else {
		buf.str("");
...
// identify secondary positrons IMOS20070725
	...
	if(ielectrons==-1) {
		WARNING("CR secondary positrons not found!");     //AWS20131106 remove return stat
	} else {
		buf.str("");
...
// identify secondary electrons AWS20100310
	...
	if(ielectrons==-1) {
		WARNING("CR secondary electrons not found!");     //AWS20131106 removed return stat
	} else {
		buf.str("");
